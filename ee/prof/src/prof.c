...
/// define sample frequency - 1ms
#define SAMPLE_FREQ     MSec2TimerBusClock(1)
...
*/
static void timer_handler(struct timer_alarm_t *trigalarm, void *arg)
{
...
static void initialize()
{
        ...
        InitializeTimerAlarm(&gp.timer);
        SetTimerAlarm(&gp.timer, SAMPLE_FREQ, &timer_handler, NULL);
        StartTimerAlarm(&gp.timer);
}
