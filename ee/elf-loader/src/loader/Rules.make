...
# C compiler flags
EE_CFLAGS := -D_EE -O2 -G0 -flto -Wall -Werror $(EE_CFLAGS)

# C++ compiler flags
EE_CXXFLAGS := -D_EE -O2 -G0 -flto -Wall -Werror $(EE_CXXFLAGS)

# Linker flags
EE_LDFLAGS := -L$(PS2SDKSRC)/ee/kernel/lib -L$(PS2SDKSRC)/ee/libc/lib -Wl,-zmax-page-size=128 -flto $(EE_LDFLAGS)
